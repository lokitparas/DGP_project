...
#ifndef __A3_MeshVertex_hpp__
#define __A3_MeshVertex_hpp__
...
class MeshVertex
{
  ...
  public:
    ...
    std::list<MeshFace*> findNeighbourPlanes(double sigma_c);
    std::list<MeshVertex*> findNeighbourVertices(double sigma_c);
